...
// 
// Create Date:     17:00:47 11/7/2023 
...
module top_level(
	...
	output UART_TX
		...
		//data lines
		wire [15:0] wr_data_out_from_rom, wr_data_ram_from_cpu, wr_data_ram_to_cpu, wr_data_to_ram, wr_data_from_ram;
    ...
    .reset(reset),
	 .clk(clk_cpu),
	 .addr_to_rom(wr_address_to_rom),							// 4bit
    .enable_to_rom(wr_enable_to_rom),
	 ...
	 .addr_to_ram(wr_address_to_ram_from_cpu),				//4bit
